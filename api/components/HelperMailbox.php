...
/**
 * Clase que contiene funciones personalizadas de conexión Imap
 * Se utiliza como base de la librería unyii2
 * Se construye el helper con una variable adicional "$isServerEncoding", ya que para la lectura de correos de Microsoft no se necesita colocar la codificación
 * Su uso se puede ver en la función "searchMailbox()" de esta misma clase "HelperMailbox"
 */
class HelperMailbox
{
    protected $imapPath;
    ...
    public $isServerEncoding = true; // Variable para definir si se utiliza la decodificacion de caracteres para leer el correo
    ...
    public function searchMailbox($criteria = 'ALL') {
         ...
         * Autor: Elvis Valera
         * Fecha: 02-06-2020
         * Info: Para los dominios de microsoft no se debe colocar la codificación en la función de búsqueda imap_search(), ya que no permite realizar busquedas personalizadas con "$criteria"
         */
        if ($this->isServerEncoding == true) {
    ...
    public function getMail($mailId, $markAsSeen = true) {
        ...
        try {
             ...
             * Autor: Elvis Valera
             * Fecha: 02-06-2020
             * Info: Se realiza validación para detectar cuando un correo no posee remitente,
                * Este caso sucede cuando es un borrador que se encuentra en proceso o una nota que es una funcion que posee Microsoft
                * Con esto se evita el error 500 en la lectura de la bandeja.
             */
            if (isset($head->from)) {
    ...
    /**
     * Valida si el correo tiene adjuntos
     */
    public function getValidateAttachment($mailId) {
